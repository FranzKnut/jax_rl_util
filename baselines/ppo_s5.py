...
class S5PPOConfig:
    ...
    ENV: object = None  # Assuming AliasPrevActionV2(env) is an object, replace `object` with the correct type if needed
    ENV_PARAMS: object = None  # Replace `object` with the correct type if needed
    ...
    S5_DO_NORM: bool = False
    S5_PRENORM: bool = False
    S5_DO_GTRXL_NORM: bool = False
...
def make_train(config, logger=DummyLogger()):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            if config["DEBUG"]:
                metric = (
                    traj_batch.info["return_info"][..., 1] * traj_batch.info["returned_episode"]
...
if __name__ == "__main__":
    env, env_params = popjym.make("RepeatFirstEasy")
